const Tab4 = ({ data }) => {
  return (
    <div className="p-8 w-full grid grid-cols-2 mobile:grid-cols-1 gap-4 mobile:gap-2">
      <div className="flex flex-col gap-6 text-xl mobile:text-lg">
        <h3 className="font-bold">{"Installation Tools for this kit"}</h3>
        <h3 className="font-bold">{"Rod Bolt Stretch Gauge"}</h3>
        <h3
          className="pl-24 mobile:pl-8 mobile:text-base"
      ...
      <div className="flex flex-col gap-6 text-xl mobile:text-lg mobile:mt-4">
